"""
packaging/build.py — PA Skills Portable build orchestrator.
...
Phase 1 scope: steps 1–4 of spec §10.2.
    ...
    4. Run PyInstaller against ui/webui.py via packaging/paskills.spec.
...
Invocation (from repo root):
    ...
    python packaging\\build.py --version 0.1.0
    python packaging\\build.py --allow-dirty
    python packaging\\build.py --skip-venv     # reuse existing build venv
    python packaging\\build.py --skip-pull     # don't re-pull agents/
...
PASKILLS_SPEC = PROJECT_ROOT / "packaging" / "paskills.spec"
REQUIREMENTS  = PROJECT_ROOT / "requirements.txt"
SOURCES_TOML  = PROJECT_ROOT / "packaging" / "sources.toml"
