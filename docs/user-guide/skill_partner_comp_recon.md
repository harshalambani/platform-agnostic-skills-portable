...
| 'ERROR: ... Stage 2 placeholder ...' naming the LLP statement parser. | The LLP statement of account parser is a guarded placeholder pending a real, de-identified specimen of that document (see AGENT.md) -- it cannot be worked around by renaming or reformatting a file; leave llp_statement blank and that leg reports 'not available' instead. |
